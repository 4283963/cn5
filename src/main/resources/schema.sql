CREATE TABLE IF NOT EXISTS reconciliation_task (
    ...
    total_order_amount  DECIMAL(18, 2) DEFAULT 0.00,
    total_payment_amount DECIMAL(18, 2) DEFAULT 0.00,
    total_difference DECIMAL(18, 2) DEFAULT 0.00,
...
CREATE TABLE IF NOT EXISTS reconciliation_difference (
    ...
    order_amount_in_base    DECIMAL(18, 2),
    payment_amount_in_base  DECIMAL(18, 2),
